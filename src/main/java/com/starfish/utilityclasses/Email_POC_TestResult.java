...
public class Email_POC_TestResult
{
	...
	public static void execute() throws Exception
	{
		 Read_PropertyFile configEmail=new Read_PropertyFile();
			...
			Email_POC_TestResult.sendMail(configEmail.From_Email(),configEmail.getMyPassword(),configEmail.gethostno(),configEmail.getport(),"true","true",false,"javax.net.ssl.SSLSocketFactory","true",to,cc,bcc,"Extent Report for Reltio",
