...
import com.starfish.utilityclasses.Email_POC_TestResult;
import com.starfish.utilityclasses.GetScreenShot;
...
public class ExtentReportBase 
{
	...
	/**
	 * To setup the extentreport with the configurations
	 */
	@BeforeSuite
	public void setUp() 
	{
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/test-output/StarFish_ExtentReport.html");
		...
		extent.setSystemInfo("User Name", "StarFish");

		htmlReporter.config().setChartVisibilityOnOpen(true);
		htmlReporter.config().setDocumentTitle("Extent Report for StarFish POC");
	...
	public void getResult(ITestResult result) throws Exception
	{
		...
		if (result.getStatus() == ITestResult.FAILURE)
		{
			...
			test.log(Status.FAIL, MarkupHelper.createLabel(result.getName() + " Test case FAILED due to below issues:",
			 ...
			 GetScreenShot.capture(DriverClass.getDriver("chrome"),result.getName());
			 
			// String screenShotPath = GetScreenShot.capture(DriverClass.getDriver(),result.getName());
	...
	//	driver.manage().window().maximize();
		...
		// WebDriver dr = new FirefoxDriver();
		 driver.get(System.getProperty("user.dir")+"\\test-output\\StarFish_ExtentReport.html");
		 driver.manage().window().maximize();
			//Email_POC_TestResult.execute();
